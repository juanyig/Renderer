 ...
 */
        ...
        public:
            ...
            void partition(BVHNode* node, size_t max_leaf_size);
            /**
           * Destructor.
           ...
           */
            ...
            bool intersect_node(BVHNode* node, const Ray &ray, Intersection *isect) const;
            bool intersect_node(BVHNode* node, const Ray &ray) const;
